    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                ...
                <p class="text-white">Hasil diagnosa masalah kulit wajah</p>
                <div class="form">
                    <div class="container">
                                                ...
                                                <table class="table table-bordered text-left">
                                                    ...
                                                    if($hasil != "0"){
                                                        ...
                                                        while($k=mysqli_fetch_array($alternatif)){
                                                            ...
                                                            <tr>
                                                                <th width="30%">REKOMENDASI SOLUSI</th>
                                                        ...
                                                        <tr>
                                                            <th width="30%">HASIL <br/> <small>Forward Chaining</small></th>
                                                            <td><b><i>Mohon maaf kami belum bisa mendeteksi masalah kulit yang anda alami</i></b></td>
                                                        </tr>                     
                                                        <tr>
                                                            <th width="30%">DESKRIPSI</th>
                                                            <td>-</td>
